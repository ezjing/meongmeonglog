...
export const dogBreeds: DogBreedDefinition[] = [
  ...
  { key: 'shih-tzu', label: '시츄', englishName: 'Shih Tzu' },
  {
    ...
    label: '아메리칸 코카 스파니엘',
    englishName: 'American Cocker Spaniel',
  },
  ...
  { key: 'chihuahua', label: '치와와', englishName: 'Chihuahua' },
  {
    ...
    label: '카발리에 킹 찰스 스패니얼',
    englishName: 'Cavalier King Charles Spaniel',
  },
...
export function filterDogBreeds(breeds: DogBreedOption[], query: string): DogBreedOption[] {
